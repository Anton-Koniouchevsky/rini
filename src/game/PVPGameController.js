...
export default class GameController {
  constructor(currentUser, pvp, openSpellModal, openEndGameModal, isEffectsMuted, isGameLoaded) {
    this.hero = currentUser.hero,
    this.pvp = pvp;
    this.id = currentUser.id;
    this.heroName = currentUser.name;
    this.heroHP = 100;
    this.enemyName = pvp.user1Name === this.heroName ? pvp.user2Name : pvp.user1Name;
    this.enemyHP = 100;
